...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {bt_cut, bt_open});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {bt_cut, bt_open});
        ...
        Thread t1 = new Thread(() -> {
            try {
                FileManager manager = new FileManager(new UiCallback() {
                    ...
                    @Override
                    public void onProcessWork(int value) {
